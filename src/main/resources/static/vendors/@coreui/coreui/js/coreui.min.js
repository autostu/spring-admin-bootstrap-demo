...
!function (e, t) {
    ...
    var i, n, s, c, u, d, l, f, p, g, h, m, v, b, y, w, I, _, C, j, S, T, L, E, O, A, x, P, D, k, Q, q, U, N, G, R, K,
        H, M, V, z, B, X, J,
        Y = (n = "ajaxLoad", s = "coreui.ajaxLoad", c = (i = t).fn[n], u = "active", d = "open", l = "view-script", f = "click", p = ".sidebar-nav .nav-dropdown", g = ".sidebar-nav .nav-link", h = ".sidebar-nav .nav-item", m = ".view-script", v = {
            ...
            return e.loadPage = function (r) {
                var o = this._element, e = this._config;
                var _r = "";
                if (r.indexOf("/") == 0) {
                    _r = r.substr(1, r.length - 1);
                } else {
                    _r = r;
                }
                i.ajax({
                    type: "GET", url: e.subpagesDirectory + _r, dataType: "html", beforeSend: function () {
                        // 删除 VIEW_SCRIPT
                        i(m).remove()
                    }, success: function (e) {
                        var t = document.createElement("div");
                        t.innerHTML = e;
                        //获取js src ，然后再加载，设置class=VIEW_SCRIPT 。 TODO css
                        var n = Array.from(t.querySelectorAll("script[src]")).map(function (e) {
                            return e.attributes.getNamedItem("src").nodeValue;
                        });
                        t.querySelectorAll("script[src]").forEach(function (e) {
                            return e.parentNode.removeChild(e)
                        }), i("body").animate({scrollTop: 0}, 0), i(o).html(t), n.length && function e(t, n) {
                            void 0 === n && (n = 0);
                ...
                i(g).removeClass(u), i(p).removeClass(d), i(p + ':has(a[href="' + e.replace(/^\//, "").split("?")[0] + '"])').addClass(d), i(h + ' a[href="' + e.replace(/^\//, "").split("?")[0] + '"]').addClass(u), this.loadPage(e)
                ...
                i(document).on(f, g + '[href!="#"]', function (e) {
                    e.preventDefault(), e.stopPropagation(), "_top" === e.currentTarget.target ? t.loadTop(e.currentTarget.href) : "_blank" === e.currentTarget.target ? t.loadBlank(e.currentTarget.href) : t.setUpUrl(e.currentTarget.pathname)
                });

                i(document).on("click", "[data-href='page']" + '[href!="#"]', function (e) {
                    e.preventDefault(), e.stopPropagation(), "_top" === e.currentTarget.target ? t.loadTop(e.currentTarget.href) : "_blank" === e.currentTarget.target ? t.loadBlank(e.currentTarget.href) : t.loadPage(e.currentTarget.pathname)
                });
            ...
            var n = t.indexOf(e), r = t.slice(0, n + 1);
            -1 !== r.map(function (e) {
            ...
            TOGGLE: "toggle"
        }, j = ".aside-menu", S = ".aside-menu-toggler", T = ["aside-menu-show", "aside-menu-sm-show", "aside-menu-md-show", "aside-menu-lg-show", "aside-menu-xl-show"], L = function () {
            function n(e) {
                this._element = e, this._addEventListeners()
            }

            return n.prototype._addEventListeners = function () {
                y(S).on(C.CLICK, function (e) {
        ...
        }), y.fn[w] = L._jQueryInterface, y.fn[w].Constructor = L, y.fn[w].noConflict = function () {
            return y.fn[w] = _, L._jQueryInterface
        }, L),
        W = (O = "sidebar", A = "coreui.sidebar", x = (E = t).fn[O], P = "active", D = "brand-minimized", k = "open", Q = "sidebar-minimized", q = {
            CLICK: "click",
            DESTROY: "destroy",
            INIT: "init",
            ...
            return e.perfectScrollbar = function (e) {
                ...
                E(M).find(K).each(function (e, t) {
                    var n = t, r = String(window.location).split("?")[0];
                    "#" === r.substr(r.length - 1) && (r = r.slice(0, -1)), E(E(n))[0].href === r && E(n).addClass(P).parents(R).add(n).each(function (e, t) {
                        E(n = t).parent().addClass(k)
                    })
                })
            }, e._addEventListeners = function () {
                var t = this;
                E(N).on(q.CLICK, function (e) {
                    e.preventDefault(), e.stopPropagation(), E(U).toggleClass(D)
                }), E(G).on(q.CLICK, function (e) {
                    e.preventDefault(), e.stopPropagation();
                    var t = e.target;
                    E(t).parent().toggleClass(k)
                }), E(z).on(q.CLICK, function (e) {
                    e.preventDefault(), e.stopPropagation(), E(U).toggleClass(Q), t.perfectScrollbar(q.TOGGLE)
                }), E(B).on(q.CLICK, function (e) {
                    e.preventDefault(), e.stopPropagation();
                    var t = e.currentTarget.dataset.toggle;
                    $(t, X)
                })
        ...
        }), E.fn[O] = J._jQueryInterface, E.fn[O].Constructor = J, E.fn[O].noConflict = function () {
            return E.fn[O] = x, J._jQueryInterface
        }, J);
    ...
    !function (e) {
        ...
        var n, r, o;
        void 0 === t && (t = document.body), n = e.match(/^--.*/i) && Boolean(document.documentMode) && 10 <= document.documentMode ? (r = {}, 0 === (o = Object.entries(document.styleSheets).filter(function (e) {
            return ":root" === e[1].cssText.substring(0, ":root".length)
        })).length && (o = Object.entries(document.styleSheets)), Object.entries(o[0][1].cssRules).filter(function (e) {
            return ".ie-custom-properties" === e[1].selectorText
        })[0][1].style.cssText.split(";").forEach(function (e) {
            if (e) {
                var t = e.split(": ")[0], n = e.split(": ")[1];
                r["--" + t.trim()] = n.trim()
            }
        }), r)[e] : window.getComputedStyle(t, null).getPropertyValue(e).replace(/^\s/, "");
        return n
        ...
        var n = "0" + parseInt(t[1], 10).toString(16), r = "0" + parseInt(t[2], 10).toString(16),
            o = "0" + parseInt(t[3], 10).toString(16);
        return "#" + n.slice(-2) + r.slice(-2) + o.slice(-2)
    }, e.AjaxLoad = Y, e.AsideMenu = F, e.Sidebar = W, Object.defineProperty(e, "__esModule", {value: !0})
});
